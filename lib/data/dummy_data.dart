...
final List<Tutor> kDummyTutors = [
  ...
  const Tutor(
    ...
    bio: 'Enjoys turning messy datasets into dashboards that make sense.',
    hourlyRate: 20,
    rating: 4.7,
    isActive: true,
    subjects: ['DATA 1', 'DATA 2'],
  ...
  const Tutor(
    ...
    name: 'Ryan Koh',
    course: 'Big Data and Analytics',
    bio: 'Data engineering enthusiast, especially pipelines and warehouses.',
    hourlyRate: 24,
    rating: 4.6,
    isActive: true,
    subjects: ['DATA 3', 'DATA 4'],
  ...
  const Tutor(
    ...
    bio: 'Into network security and ethical hacking, happy to explain basics.',
    hourlyRate: 22,
    rating: 4.8,
    isActive: true,
    subjects: ['CYBER 1', 'CYBER 2'],
  ...
  const Tutor(
    ...
    name: 'Michelle Ong',
    course: 'Cybersecurity',
    bio: 'Focuses on penetration testing and audits, patient with beginners.',
    hourlyRate: 25,
    rating: 4.9,
    isActive: true,
    subjects: ['CYBER 3', 'CYBER 4'],
